...
var IniLoader = __webpack_require__(295).IniLoader;
/**
...
var AWS = __webpack_require__(984);
...
var LRU_1 = __webpack_require__(829);
var CACHE_SIZE = 1000;
/**
...
var AWS = __webpack_require__(984);
var CognitoIdentity = __webpack_require__(594);
var STS = __webpack_require__(101);
...
var AWS = __webpack_require__(984);
var Api = __webpack_require__(774);
...
(function() {
  ...
  XMLDTDElement = __webpack_require__(531);

  XMLDTDEntity = __webpack_require__(802);

  XMLDTDNotation = __webpack_require__(734);
...
var escapeAttribute = __webpack_require__(459).escapeAttribute;
...
var eventMessageChunker = __webpack_require__(937).eventMessageChunker;
var parseEvent = __webpack_require__(726).parseEvent;
...
var util = __webpack_require__(995);
...
(function() {
  ...
  parser = __webpack_require__(997);
...
var util = __webpack_require__(984).util;
...
var util = __webpack_require__(995);
var Rest = __webpack_require__(571);
var Json = __webpack_require__(485);
var JsonBuilder = __webpack_require__(411);
var JsonParser = __webpack_require__(419);
...
var v4 = __webpack_require__(563);
...
(function() {
  ...
  ref = __webpack_require__(779), isObject = ref.isObject, isFunction = ref.isFunction;
...
var AWS = __webpack_require__(984);
var util = __webpack_require__(995);
var QueryParamSerializer = __webpack_require__(274);
var Shape = __webpack_require__(509);
var populateHostPrefix = __webpack_require__(887).populateHostPrefix;
...
var EventMessageChunkerStream = __webpack_require__(635).EventMessageChunkerStream;
var EventUnmarshallerStream = __webpack_require__(982).EventUnmarshallerStream;
...
var util = __webpack_require__(995);
var XmlNode = __webpack_require__(78).XmlNode;
var XmlText = __webpack_require__(618).XmlText;
...
var AWS = __webpack_require__(984);
var v4Credentials = __webpack_require__(497);
var inherit = AWS.util.inherit;
...
var AWS = __webpack_require__(984);
var resolveRegionalEndpointsFlag = __webpack_require__(339);
...
var AWS = __webpack_require__(984);
var SequentialExecutor = __webpack_require__(115);
var DISCOVER_ENDPOINT = __webpack_require__(420).discoverEndpoint;
/**
...
AWS.EventListeners = {
  ...
  Json: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __webpack_require__(485);
  ...
  Rest: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __webpack_require__(571);
    add('BUILD', 'build', svc.buildRequest);
    add('EXTRACT_DATA', 'extractData', svc.extractData);
    add('EXTRACT_ERROR', 'extractError', svc.extractError);
  }),
  ...
  RestJson: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __webpack_require__(138);
    add('BUILD', 'build', svc.buildRequest);
    add('EXTRACT_DATA', 'extractData', svc.extractData);
    add('EXTRACT_ERROR', 'extractError', svc.extractError);
  }),
  ...
  RestXml: new SequentialExecutor().addNamedListeners(function(add) {
    var svc = __webpack_require__(633);
    add('BUILD', 'build', svc.buildRequest);
    add('EXTRACT_DATA', 'extractData', svc.extractData);
    add('EXTRACT_ERROR', 'extractError', svc.extractError);
  }),
...
var property = __webpack_require__(995).property;
...
var Collection = __webpack_require__(796);
...
var xml2js = __webpack_require__(117);
...
(function() {
  ...
  ref = __webpack_require__(779), isObject = ref.isObject, isFunction = ref.isFunction, isPlainObject = ref.isPlainObject;
...
var Int64 = __webpack_require__(127).Int64;

var splitMessage = __webpack_require__(147).splitMessage;
...
const { getInput, setFailed, debug } = __webpack_require__(827);
const Lambda = __webpack_require__(598);
...
Object.defineProperty(apiLoader.services['cognitoidentity'], '2014-06-30', {
  get: function get() {
    ...
    model.paginators = __webpack_require__(39).pagination;
    return model;
  },
  enumerable: true,
  configurable: true
...
Object.defineProperty(apiLoader.services['lambda'], '2015-03-31', {
  get: function get() {
    ...
    model.paginators = __webpack_require__(69).pagination;
...
var util = __webpack_require__(995);
var regionConfig = __webpack_require__(9);
...
var escapeElement = __webpack_require__(116).escapeElement;
...
var AWS = __webpack_require__(984);
var inherit = AWS.util.inherit;
var jmespath = __webpack_require__(206);
...
(function() {
  ...
  ref = __webpack_require__(779), isObject = ref.isObject, isFunction = ref.isFunction, isEmpty = ref.isEmpty;
...
util.createEventStream = util.stream.Readable ?
  __webpack_require__(298).createEventStream : __webpack_require__(95).createEventStream;
util.realClock = __webpack_require__(24);
util.clientSideMonitoring = {
  Publisher: __webpack_require__(596).Publisher,
  configProvider: __webpack_require__(473),
};
util.iniLoader = __webpack_require__(26).iniLoader;
 ...
 * @api private
 */
module.exports = AWS = __webpack_require__(984);
...
AWS.XML.Parser = __webpack_require__(543);
...
var parseMessage = __webpack_require__(575).parseMessage;
...
var Collection = __webpack_require__(796);
var Operation = __webpack_require__(327);
var Shape = __webpack_require__(509);
var Paginator = __webpack_require__(449);
var ResourceWaiter = __webpack_require__(107);
...
var memoizedProperty = __webpack_require__(995).memoizedProperty;
...
(function() {
  ...
  builder = __webpack_require__(776);
...
var AWS = __webpack_require__(984);
var AcceptorStateMachine = __webpack_require__(175);
var inherit = AWS.util.inherit;
 ...
 */
var AWS = { util: __webpack_require__(995) };
...
AWS.util.update(AWS, {
   ...
   */
  Protocol: {
    Json: __webpack_require__(485),
    Query: __webpack_require__(257),
    Rest: __webpack_require__(571),
    RestJson: __webpack_require__(138),
    RestXml: __webpack_require__(633)
  },
   ...
   */
  XML: {
    Builder: __webpack_require__(323),
   ...
   */
  JSON: {
    Builder: __webpack_require__(411),
   ...
   */
  Model: {
    Api: __webpack_require__(774),
    Operation: __webpack_require__(327),
    Shape: __webpack_require__(509),
    Paginator: __webpack_require__(449),
    ResourceWaiter: __webpack_require__(107)
  },

  /**
   * @api private
   */
  apiLoader: __webpack_require__(429),

  /**
   * @api private
   */
  EndpointCache: __webpack_require__(40).EndpointCache
});
...
var util = {
  ...
  userAgent: function userAgent() {
    ...
    var agent = 'aws-sdk-' + name + '/' + __webpack_require__(984).VERSION;
  ...
  date: {
    ...
    getDate: function getDate() {
      if (!AWS) AWS = __webpack_require__(984);
  ...
  uuid: {
    v4: function uuidV4() {
      return __webpack_require__(181).v4();
    }
  },
